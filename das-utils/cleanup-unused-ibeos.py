...
)  # in order to import top level modules
...
if days < 30:
    days = 30
if (unused_days_threshold - days) < 30:
    unused_days_threshold = days + 30
...
e, o = run_cmd(
    "PYTHONPATH=%s/.. %s/ib-datasets.py --days %s" % (script_path, script_path, days)
)
if e:
    print(o)
    exit(1)
